...
> Inoltre sono presenti altre funzionalità come quella che permette all'utente di visualizzare la lista delle prenotazioni effettuate, implementata con i relativi filtri, consentendogli anche di eliminare eventuali prenotazioni inserite dall'utente stesso.
...
> Uso delle classi utilizzato per l'impostazione del progetto 
  ...
  <div align="center"><img src="https://github.com/giovannipalmieri26/javaProject/blob/main/UML%20diagrams/Diagramma%20delle%20classi.jpg" width="600" height="400" ></div>
...
edamam food|https://api.edamam.com/api/food-database/v2/parser?app_key=9ba5db401b1521a8361aece88787a139&app_id=1f1731cf&ingr=|Utilizzato per i cibi che si possono ordinare
