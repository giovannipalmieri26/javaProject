...
/**
 * Main class used for start application
 */
public class App {

    static JobService service;
    static Scanner in = new Scanner(System.in); // for read console input
    private static int retry = 0; // for avoid too much unexpected error
