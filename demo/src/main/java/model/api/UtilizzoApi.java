...
import model.ristorante.Piatto;
...
public class UtilizzoApi {
	 ...
	 */
	private String urlMenu = "https://api.edamam.com/api/food-database/v2/parser";
	...
	public Piatto valorizzaPiatto(String cibo) {
			this.urlMenu= "https://api.edamam.com/api/food-database/v2/parser?app_key=9ba5db401b1521a8361aece88787a139&app_id=1f1731cf&ingr=" + cibo;
			JSONObject obj = this.leggiApi(this.urlMenu);
