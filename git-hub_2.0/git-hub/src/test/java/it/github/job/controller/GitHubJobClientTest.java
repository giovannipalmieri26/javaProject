...
class GitHubJobClientTest {
    ...
    @Test
    void badParameters() {
        // testiamo che se manca un parametro obbligatorio ci sia un errore
    ...
    @Test
    void badUrl() {
        // testiamo che se nelle impostazioni ci sia un url errato venga lanciato un errore
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    void nullUrl() {
        // testiamo che se non venga passato l'url la classe vada in errore
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
    ...
    void search() throws UnexpectedException {
        // Testiamo che il client risponda correttamente nel caso gli input siano corretti, non importa 
    	// che siano vuoti ma solo che non vada in errore
        GitHubJobClient client = new GitHubJobClient(url);
        JobSearchFilter filter = new JobSearchFilter();
